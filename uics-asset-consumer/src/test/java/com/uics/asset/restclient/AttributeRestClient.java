 ...
 */
public class AttributeRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(AttributeRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/attributes";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<Attribute>> result = (RestResult<List<Attribute>>)restResult;
                ...
                LOGGER.info("Attribute list:{}", JSON.toJSON(restResult));
            }
        }, URL, AttributeRestClient.TOKEN);
    }
...
////        attribute.set*("*");
//
//        Response response = getBuilder(URL, attributeRestClient.TOKEN).post(Entity.entity(attribute, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
