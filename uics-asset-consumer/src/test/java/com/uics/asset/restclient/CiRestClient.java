 ...
 */
public class CiRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(CiRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/cis";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<Ci>> result = (RestResult<List<Ci>>)restResult;
                ...
                LOGGER.info("Ci list:{}", JSON.toJSON(restResult));
            }
        }, URL, CiRestClient.TOKEN);
    }
...
////        ci.set*("*");
//
//        Response response = getBuilder(URL, ciRestClient.TOKEN).post(Entity.entity(ci, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
