package com.uics.asset.servlet;
...
public class PetStoreApplication extends Application {
    ...
    public PetStoreApplication() {
        ...
        beanConfig.setFilterClass("com.uics.asset.util.ApiAuthorizationFilterImpl");
        beanConfig.setResourcePackage("com.uics.asset.facade");
